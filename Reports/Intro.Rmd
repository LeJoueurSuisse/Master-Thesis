...
ets.consm.fit %>% 
  ...
  autoplot(cons.m.tot %>%
             filter_index("2018-01-01" ~ "2021-12"), level = NULL, size = c(1.2)) +
  labs(title = "Monthly forecast using the ETS method",
       subtitle = "Ammount in millions of kWh",
       y = "", x = "")
...
tslm.consm.fit %>%
  ...
  autoplot(cons.m.tot %>%
             filter_index("2018-01-01" ~ "2021-12")) +
  labs(title = "Monthly forecast using the TSLM method",
       subtitle = "Ammount in millions of kWh",
       y = "", x = "")
```
